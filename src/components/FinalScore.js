  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        {userData.host && (
          <TouchableOpacity style={styles.button} onPress={startGameButton} disabled={isLoading}>
      ...
      {captions.map((caption, index) => (
        <View key={index} style={styles.captionContainer}>
          {caption.round_image_uid && (
            <Image source={{ uri: caption.round_image_uid }} style={styles.image} />
          )}
          {caption.round_number && (
            <Text style={styles.captionText}>Round: {caption.round_number}</Text>
          )}
      ...
      {userData.host && (
        <TouchableOpacity style={styles.button} onPress={sendEmail} disabled={isSending}>
          <Text style={styles.buttonText}>
