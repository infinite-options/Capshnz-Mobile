// ✅ ✅ ✅ POLYFILLS AT THE TOP — REQUIRED FOR HERMES + IOS + ABLY
...
import WaitingRoom from "./src/components/WatitingRoom"; // be sure the filename is corrected
...
export default function App() {
  ...
  return (
    <ErrorContext.Provider value={{ show, setShow, onRetry, setOnRetry, title, setTitle, description, setDescription }}>
      <NavigationContainer>
